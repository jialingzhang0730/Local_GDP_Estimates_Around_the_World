...
# use R version 4.2.1 (2022-06-23)
...
chn_ind_pak <- read_sf("step1_obtain_gis_data/inputs/CGAZ_ADM1/gadm_410-levels.gpkg", layer = "ADM_0") %>% 
...
gadm_levl0 <- read_sf("step1_obtain_gis_data/inputs/CGAZ_ADM1/gadm_410-levels.gpkg", layer = "ADM_0") %>% 
    filter(!COUNTRY %in% c("China", "India", "Pakistan")) %>% 
...
# 2. process prov geom
chn_ind_pak <- read_sf("step1_obtain_gis_data/inputs/CGAZ_ADM1/gadm_410-levels.gpkg", layer = "ADM_1") %>% 
    filter(COUNTRY %in% c("China", "India", "Pakistan")) %>% 
...
gadm_levl1 <- read_sf("step1_obtain_gis_data/inputs/CGAZ_ADM1/gadm_410-levels.gpkg", layer = "ADM_1") %>% 
    filter(!COUNTRY %in% c("China", "India", "Pakistan")) %>% 
...
difference <- qgis_run_algorithm(
  ...
  INPUT = "step1_obtain_gis_data/inputs/CGAZ_ADM1/geoBoundariesCGAZ_ADM1.geojson", 
...
difference <- qgis_run_algorithm(
  alg = "native:difference",
  INPUT = read_sf("step1_obtain_gis_data/inputs/CGAZ_ADM1/gadm_410-levels.gpkg", layer = "ADM_2"), 
  OVERLAY = "step1_obtain_gis_data/inputs/large_inland_waters_geom_GLWD_level1/glwd_1.shp", 
