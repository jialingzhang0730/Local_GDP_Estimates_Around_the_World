# --------------------------------- Task Summary --------------------------------- #
# This file retrieves regional GDP data for Russia for years 2020, 2021, and 2022.
#
...
# Statistics Service. The relevant data can be accessed at: 
...
# slightly from the OECD's, manual extraction is recommended. The data values for Russia's 
# OECD administrative units should be derived as described in the 
# "inputs/gdp_data/regional/RUS/RUS.xlsx" file.
# -------------------------------------------------------------------------------- #
