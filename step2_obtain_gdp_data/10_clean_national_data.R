...
imf_pop <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/IMF_data/WEO_Data.xlsx")  %>% 
...
imf_gdp_const_2021_PPP <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/IMF_data/WEO_Data.xlsx")  %>% 
...
imf_gdp_crt_PPP <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/IMF_data/WEO_Data.xlsx")  %>% 
...
# current US dollars
imf_gdp_crt_us <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/IMF_data/WEO_Data.xlsx")  %>% 
  filter(`Subject Descriptor` == "Gross domestic product, current prices",
...
index <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/US_census_bureau_data/annual-index-value_annual-percent-change.xls", skip = 2)  %>% 
...
# population
wb_pop <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/world_bank_data/population/API_SP.POP.TOTL_DS2_en_excel_v2_19296.xls", sheet = "Data", skip = 3)  %>% 
...
# current US dollars
wb_gdp_crt_us <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/world_bank_data/GDP_current_USdollar/API_NY.GDP.MKTP.CD_DS2_en_excel_v2_19310.xls", sheet = "Data", skip = 3)  %>% 
  rename(iso = `Country Code`)  %>% 
  filter(iso %in% iso_get_fm_wb)  %>% # only select those isos that IMF misses and those we want from world bank 
...
wb_gdp_crt_PPP <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/world_bank_data/GDP_PPP_current/API_NY.GDP.MKTP.PP.CD_DS2_en_excel_v2_19548.xls", sheet = "Data", skip = 3)  %>% 
  rename(iso = `Country Code`)  %>% 
  filter(iso %in% iso_get_fm_wb)  %>% # only select those isos that IMF misses and those we want from world bank 
  dplyr::select(-c(`Country Name`, "Indicator Name", "Indicator Code"))  %>% 
  pivot_longer(cols = matches("\\d{4}"), names_prefix = "X", names_to = "year")  %>% 
...
wb_gdp_const_2021_PPP <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/world_bank_data/GDP_PPP_const_2021/API_NY.GDP.MKTP.PP.KD_DS2_en_excel_v2_20528.xls", sheet = "Data", skip = 3)  %>% 
  rename(iso = `Country Code`)  %>% 
  filter(iso %in% iso_get_fm_wb)  %>% # only select those isos that IMF misses and those we want from world bank 
  dplyr::select(-c(`Country Name`, "Indicator Name", "Indicator Code"))  %>% 
  pivot_longer(cols = matches("\\d{4}"), names_prefix = "X", names_to = "year")  %>% 
...
pop_cub_eri_prk <- read_excel("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/world_bank_data/population/API_SP.POP.TOTL_DS2_en_excel_v2_19296.xls", sheet = "Data", skip = 3)  %>% 
...
un_gdp_crt_us <- read.csv("version2_year2012_2022/step2_obtain_gdp_data/inputs/gdp_data/national/UN_data/UNdata_Export_20250426_211303453.csv") %>% 
...
write.csv(national_gdp_current_USD, "version2_year2012_2022/step2_obtain_gdp_data/temp/national_gdp_current_USD.csv", row.names = F)
write.csv(national_gdp_const_2021_USD, "version2_year2012_2022/step2_obtain_gdp_data/temp/national_gdp_const_2021_USD.csv", row.names = F)
write.csv(national_gdp_current_PPP, "version2_year2012_2022/step2_obtain_gdp_data/temp/national_gdp_current_PPP.csv", row.names = F)
write.csv(national_gdp_const_2021_PPP, "version2_year2012_2022/step2_obtain_gdp_data/temp/national_gdp_const_2021_PPP.csv", row.names = F)
...
write.csv(national_gdpc_current_USD, "version2_year2012_2022/step2_obtain_gdp_data/temp/national_gdpc_current_USD.csv", row.names = F)
write.csv(national_gdpc_const_2021_USD, "version2_year2012_2022/step2_obtain_gdp_data/temp/national_gdpc_const_2021_USD.csv", row.names = F)
write.csv(national_gdpc_current_PPP, "version2_year2012_2022/step2_obtain_gdp_data/temp/national_gdpc_current_PPP.csv", row.names = F)
write.csv(national_gdpc_const_2021_PPP, "version2_year2012_2022/step2_obtain_gdp_data/temp/national_gdpc_const_2021_PPP.csv", row.names = F)
