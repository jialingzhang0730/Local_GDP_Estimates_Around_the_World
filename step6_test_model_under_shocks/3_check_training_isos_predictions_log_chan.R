...
# Predictions for the years 2020 to 2022 are out-of-sample. Predictions for years
...
load("step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_1deg_postadjust_pop_dens_no_extra_adjust_up_to_2019.RData")
...
# read the predicted GDP
load("step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_0_5deg_postadjust_pop_dens_no_extra_adjust_up_to_2019.RData")
...
# read the predicted GDP
load("step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_0_25deg_postadjust_pop_dens_no_extra_adjust_up_to_2019.RData")
...
ggsave("step6_test_model_under_shocks/outputs/log_level_change_r2_training_all_0_25deg.png", plot = combined_plot, width = 18, height = 12, bg = "white")
