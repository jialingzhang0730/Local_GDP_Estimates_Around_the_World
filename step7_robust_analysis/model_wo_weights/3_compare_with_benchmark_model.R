...
importance_1deg <- read.csv("step7_robust_analysis/model_wo_weights/outputs/importance_scores_1deg.csv")  %>%
  clean_names()
importance_0_5deg <- read.csv("step7_robust_analysis/model_wo_weights/outputs/importance_scores_0_5deg.csv") %>%
  clean_names()
importance_0_25deg <- read.csv("step7_robust_analysis/model_wo_weights/outputs/importance_scores_0_25deg.csv")  %>%
  clean_names()
...
latex_table <- kable(data, "latex", booktabs = TRUE, escape = FALSE, align = 'lccc', col.names = c(" ", "1-degree Model", "0.5-degree Model", "0.25-degree Model")) %>%
  ...
  pack_rows("Panel C: Variables and Importance Scores", 9, 18, bold = FALSE, italic = TRUE)

latex_table <- gsub("R2", "\\$R^2\\$", latex_table)

save_kable(latex_table, file = "step7_robust_analysis/model_wo_weights/outputs/model9_tuning/CV_metric_table.tex")
...
test_0_25deg <- read.csv("step7_robust_analysis/model_wo_weights/outputs/GDPC_0_25deg_postadjust_pop_dens_no_extra_adjust_wo_wgt.csv")
...
ggsave("step7_robust_analysis/model_wo_weights/outputs/log_level_change_r2_use_model_upto_2019.png", plot = combined_plot, width = 18, height = 12, bg = "white")
...
ggsave("step7_robust_analysis/model_wo_weights/outputs/log_level_change_r2_training_all.png", plot = combined_plot, width = 18, height = 12, bg = "white")
