...
write.csv(GDPC_1deg_postadjust_pop_dens_no_extra_adjust, file = "step7_robust_analysis/model_wo_weights/outputs/GDPC_1deg_postadjust_pop_dens_no_extra_adjust_m_mse.csv", row.names = FALSE)
...
write.csv(GDPC_0_5deg_postadjust_pop_dens_no_extra_adjust, file = "step7_robust_analysis/model_wo_weights/outputs/GDPC_0_5deg_postadjust_pop_dens_no_extra_adjust_m_mse.csv", row.names = FALSE)
...
write.csv(GDPC_0_25deg_postadjust_pop_dens_no_extra_adjust, file = "step7_robust_analysis/model_wo_weights/outputs/GDPC_0_25deg_postadjust_pop_dens_no_extra_adjust_m_mse.csv", row.names = FALSE)
