...
#load the model
load("step7_robust_analysis/model_wo_weights/outputs/model9_tuning/put_all_isos_to_train/rf_model9_good_grid_search_1deg.RData")
rf_model_good <- rf_model9_good_grid_search_1deg

importance_scores <- vip::vi(rf_model_good) %>% as.data.frame()
write.csv(importance_scores, "step7_robust_analysis/model_wo_weights/outputs/importance_scores_1deg.csv", row.names = FALSE)
...
save(pred_1deg_with_prov_bound_postadjust_pop_dens_no_extra_adjust, file = "step7_robust_analysis/model_wo_weights/outputs/pred_1deg_with_prov_bound_postadjust_pop_dens_no_extra_adjust.RData")
...
write.csv(GDPC_1deg_postadjust_pop_dens_no_extra_adjust, file = "step7_robust_analysis/model_wo_weights/outputs/GDPC_1deg_postadjust_pop_dens_no_extra_adjust_wo_wgt.csv", row.names = FALSE)

# ---------------------------------------------------------------------------------------------------------------------------------------
# 0.5 degree

#load the model
load("step7_robust_analysis/model_wo_weights/outputs/model9_tuning/put_all_isos_to_train/rf_model9_good_grid_search_0_5deg.RData")
rf_model_good <- rf_model9_good_grid_search_0_5deg

importance_scores <- vip::vi(rf_model_good) %>% as.data.frame()
write.csv(importance_scores, "step7_robust_analysis/model_wo_weights/outputs/importance_scores_0_5deg.csv", row.names = FALSE)
...
write.csv(GDPC_0_5deg_postadjust_pop_dens_no_extra_adjust, file = "step7_robust_analysis/model_wo_weights/outputs/GDPC_0_5deg_postadjust_pop_dens_no_extra_adjust_wo_wgt.csv", row.names = FALSE)

# ---------------------------------------------------------------------------------------------------------------------------------------
# 0.25 degree

#load the model
load("step7_robust_analysis/model_wo_weights/outputs/model9_tuning/put_all_isos_to_train/rf_model9_good_grid_search_0_25deg.RData")
rf_model_good <- rf_model9_good_grid_search_0_25deg

importance_scores <- vip::vi(rf_model_good) %>% as.data.frame()
write.csv(importance_scores, "step7_robust_analysis/model_wo_weights/outputs/importance_scores_0_25deg.csv", row.names = FALSE)
...
write.csv(GDPC_0_25deg_postadjust_pop_dens_no_extra_adjust, file = "step7_robust_analysis/model_wo_weights/outputs/GDPC_0_25deg_postadjust_pop_dens_no_extra_adjust_wo_wgt.csv", row.names = FALSE)
...
save(pred_1deg_with_prov_bound_postadjust_pop_dens_no_extra_adjust_upto_2019, file = "step7_robust_analysis/model_wo_weights/outputs/pred_1deg_with_prov_bound_postadjust_pop_dens_no_extra_adjust_upto_2019.RData")
...
save(GDPC_1deg_postadjust_pop_dens_no_extra_adjust_up_to_2019, file = "step7_robust_analysis/model_wo_weights/outputs/GDPC_1deg_postadjust_pop_dens_no_extra_adjust_up_to_2019.RData")
