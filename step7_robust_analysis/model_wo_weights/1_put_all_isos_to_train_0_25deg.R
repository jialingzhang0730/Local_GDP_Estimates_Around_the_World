...
required_cols <- c("GCP_share_0_25deg", "GCP_0_25deg", "state_total_GDP", "pop_total", 
                   "cell_id", "subcell_id", "subcell_id_0_25", "iso", "year", "is_developing")
      ...
      tryCatch({
        ...
        for (i in seq_along(df.cv$splits)) {
          ...
          tryCatch({
            ...
            fold_required <- c("GCP_share_0_25deg", "GCP_0_25deg", "state_total_GDP", 
                             "pop_total", "cell_id", "subcell_id", "subcell_id_0_25", "iso", "year")
            ...
            mse_chan_dped_fit[i] <- MSE_chan(developed_fit_ch$GCP_0_25deg, developed_fit_ch$prev_yr_true_gdp, 
            ...
            o_r2_chan_dped_fit[i] <- overall_r2_chan(developed_fit_ch$GCP_0_25deg, developed_fit_ch$prev_yr_true_gdp,
                                                    developed_fit_ch$pred_GCP, developed_fit_ch$prev_yr_pred_gdp)
            w_r2_levl_dped_fit[i] <- within_iso_r2_levl(developed_fit, GCP_0_25deg, pred_GCP)
            w_r2_chan_dped_fit[i] <- within_iso_r2_chan(developed_fit_ch, GCP_0_25deg, prev_yr_true_gdp, 
            ...
            mse_chan_dped[i] <- MSE_chan(developed_ch$GCP_0_25deg, developed_ch$prev_yr_true_gdp,
            ...
            o_r2_chan_dped[i] <- overall_r2_chan(developed_ch$GCP_0_25deg, developed_ch$prev_yr_true_gdp,
                                                developed_ch$pred_GCP, developed_ch$prev_yr_pred_gdp)
            w_r2_levl_dped[i] <- within_iso_r2_levl(developed, GCP_0_25deg, pred_GCP)
            w_r2_chan_dped[i] <- within_iso_r2_chan(developed_ch, GCP_0_25deg, prev_yr_true_gdp, 
                                                   pred_GCP, prev_yr_pred_gdp)
