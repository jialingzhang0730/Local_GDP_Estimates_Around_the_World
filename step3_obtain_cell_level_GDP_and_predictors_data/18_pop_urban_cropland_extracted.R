# --------------------------------- Task Summary --------------------------------- #
# This file obtains each cell's nighttime light emitted from urban areas and cropland areas.
# We split each city's geometry into sections corresponding to each landcover type present
# within its boundary, resulting in potentially multiple polygons per cell, each tagged with a
