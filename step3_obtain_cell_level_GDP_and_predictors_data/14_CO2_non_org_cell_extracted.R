...
data_folder <- "step3_obtain_cell_level_GDP_and_predictors_data/inputs/CO2_non_org_specific_sectors"
sectors <- list.dirs(path = data_folder, full.names = FALSE, recursive = FALSE)

combined_results <- data.frame()

# Function to extract CO2_non_org data for a given sector
extract_sector_data <- function(sector) {
  ...
  # Rename the CO2_non_org column to include the sector name
  emi_extracted <- emi_extracted %>%
    rename(!!paste0("CO2_non_org_", sector) := CO2_non_org)
...
CO2_non_org_full_1deg <- combined_results
                      
save(CO2_non_org_full_1deg, file = "step3_obtain_cell_level_GDP_and_predictors_data/outputs/CO2_non_org_full_1deg.RData")
...
CO2_non_org_full_0_5deg <- combined_results
                      
save(CO2_non_org_full_0_5deg, file = "step3_obtain_cell_level_GDP_and_predictors_data/outputs/CO2_non_org_full_0_5deg.RData")
...
CO2_non_org_full_0_25deg <- combined_results
                      
save(CO2_non_org_full_0_25deg, file = "step3_obtain_cell_level_GDP_and_predictors_data/outputs/CO2_non_org_full_0_25deg.RData")
