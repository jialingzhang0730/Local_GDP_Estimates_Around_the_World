...
developed_list <- read_excel("step4_benchmark_model/inputs/list_developed_isos.xlsx") %>%
  filter(developed %in% unique(predict_data_complete_1deg$iso)) %>% 
  pull(developed)

developed_group <- c(developed_list, unique(USA$iso))

set.seed(12345678)
random_countries <- sample(developed_list, 2)
...
write.csv(validation_df_iso, file = "step4_benchmark_model/outputs/new_data_valid_iso_1deg.csv",row.names = FALSE)
write.csv(testing_df_year, file = "step4_benchmark_model/outputs/new_data_test_year_1deg.csv", row.names = FALSE)
write.csv(testing_df_iso, file = "step4_benchmark_model/outputs/new_data_test_iso_1deg.csv", row.names = FALSE)
...
write.csv(training_df, file = "step4_benchmark_model/outputs/new_data_train_0_5deg.csv", row.names = FALSE)
write.csv(validation_df_year, file = "step4_benchmark_model/outputs/new_data_valid_year_0_5deg.csv",row.names = FALSE)
write.csv(validation_df_iso, file = "step4_benchmark_model/outputs/new_data_valid_iso_0_5deg.csv",row.names = FALSE)
write.csv(testing_df_year, file = "step4_benchmark_model/outputs/new_data_test_year_0_5deg.csv", row.names = FALSE)
write.csv(testing_df_iso, file = "step4_benchmark_model/outputs/new_data_test_iso_0_5deg.csv", row.names = FALSE)
...
write.csv(training_df, file = "step4_benchmark_model/outputs/new_data_train_0_25deg.csv", row.names = FALSE)
write.csv(validation_df_year, file = "step4_benchmark_model/outputs/new_data_valid_year_0_25deg.csv",row.names = FALSE)
write.csv(validation_df_iso, file = "step4_benchmark_model/outputs/new_data_valid_iso_0_25deg.csv",row.names = FALSE)
write.csv(testing_df_year, file = "step4_benchmark_model/outputs/new_data_test_year_0_25deg.csv", row.names = FALSE)
write.csv(testing_df_iso, file = "step4_benchmark_model/outputs/new_data_test_iso_0_25deg.csv", row.names = FALSE)
