...
importance_plot <- vip(rf_model_good, num_features = 36, aesthetics = list(fill = "steelblue",color = "black")) +
...
ggsave("step4_benchmark_model/outputs/importance_plot_1deg_all_isos.pdf", plot=importance_plot)

importance_scores <- vip::vi(rf_model_good) %>% as.data.frame()
write.csv(importance_scores, "step4_benchmark_model/outputs/importance_scores_1deg.csv", row.names = FALSE)
...
predictions <- as.data.frame(rf_model_good$fit$predictions)
...
developed_list <- read_excel("step4_benchmark_model/inputs/list_developed_isos.xlsx") %>%
  pull(developed)

developed_group <- c(developed_list)
...
GDP_loss_1deg_all_train <- GDP_loss_wide_1deg %>% 
  ...
  dplyr::select(iso, `2012`, `2013`, `2014`, `2015`, `2016`, `2017`, `2018`,`2019`,`2020`,`2021`,`2022`)
...
importance_plot <- vip(rf_model_good, num_features = 36, aesthetics = list(fill = "steelblue",color = "black")) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size = 14, face = "bold"),
        axis.title = element_text(size = 14),
        axis.text = element_text(size = 14))
ggsave("step4_benchmark_model/outputs/importance_plot_0_5deg_all_isos.pdf", plot=importance_plot)

importance_scores <- vip::vi(rf_model_good) %>% as.data.frame()
write.csv(importance_scores, "step4_benchmark_model/outputs/importance_scores_0_5deg.csv", row.names = FALSE)
...
save_latex_stargazer(R2_0_5deg_all_train, "step4_benchmark_model/outputs/R2_0_5deg_all_train.tex")
save_latex_stargazer(GDP_loss_0_5deg_all_train, "step4_benchmark_model/outputs/GDP_loss_0_5deg_all_train.tex")
save_latex_stargazer(R2_chan_0_5deg_all_train, "step4_benchmark_model/outputs/R2_annual_chan_0_5deg_all_train.tex")
...
importance_plot <- vip(rf_model_good, num_features = 36, aesthetics = list(fill = "steelblue",color = "black")) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size = 14, face = "bold"),
        axis.title = element_text(size = 14),
        axis.text = element_text(size = 14))
ggsave("step4_benchmark_model/outputs/importance_plot_0_25deg_all_isos.pdf", plot=importance_plot)

importance_scores <- vip::vi(rf_model_good) %>% as.data.frame()
write.csv(importance_scores, "step4_benchmark_model/outputs/importance_scores_0_25deg.csv", row.names = FALSE)
...
save_latex_stargazer(R2_0_25deg_all_train, "step4_benchmark_model/outputs/R2_0_25deg_all_train.tex")
save_latex_stargazer(GDP_loss_0_25deg_all_train, "step4_benchmark_model/outputs/GDP_loss_0_25deg_all_train.tex")
save_latex_stargazer(R2_chan_0_25deg_all_train, "step4_benchmark_model/outputs/R2_annual_chan_0_25deg_all_train.tex")
...
p1 <- ggplot(data_results_full_1deg %>% filter(!(GCP_1deg == 0 | pred_GCP_1deg == 0)), aes(x=log(GCP_1deg), y = log(pred_GCP_1deg))) +
  ...
  theme_minimal()+ 
  theme_bw()+
  labs(subtitle = "1-degree model",  # Unit: const 2021 billion USD 
       x = "log(True cell GDP)",
       y = "log(Pred cell GDP)") +
...
p2 <- ggplot(data_results_full_0_5deg %>% filter(!(GCP_0_5deg == 0 | pred_GCP_0_5deg == 0)), aes(x=log(GCP_0_5deg), y = log(pred_GCP_0_5deg))) +
  ...
  theme_minimal()+ 
  theme_bw()+
  labs(subtitle = "0.5-degree model",  # Unit: const 2021 billion USD 
       x = "log(True cell GDP)",
       y = "log(Pred cell GDP)") +
  theme(plot.title = element_text(hjust = 0.5, size = 14),
        plot.subtitle = element_text(hjust = 0.5, size = 12),
...
p3 <- ggplot(data_results_full_0_25deg %>% filter(!(GCP_0_25deg == 0 | pred_GCP_0_25deg == 0)), aes(x=log(GCP_0_25deg), y = log(pred_GCP_0_25deg))) +
  ...
  theme_minimal()+ 
  theme_bw()+
  labs(subtitle = "0.25-degree model", # Unit: const 2021 billion USD 
       x = "log(True cell GDP)",
       y = "log(Pred cell GDP)") +
  theme(plot.title = element_text(hjust = 0.5, size = 14),
        plot.subtitle = element_text(hjust = 0.5, size = 12),
...
ggsave("step4_benchmark_model/outputs/compare_gcp_pred_with_truth_scatter_plot_all_isos.png", plot = combined_plot, width = 10, height = 3, bg = "white")
