...
save(predict_data_results_1deg_with_prov_boundary, file = "step5_predict_and_post_adjustments_log_change/outputs/predict_data_results_1deg_with_prov_boundary.RData")
...
save(predict_data_results_1deg_without_prov_boundary, file = "step5_predict_and_post_adjustments_log_change/outputs/predict_data_results_1deg_without_prov_boundary.RData")
...
save(predict_data_results_0_5deg_with_prov_boundary, file = "step5_predict_and_post_adjustments_log_change/outputs/predict_data_results_0_5deg_with_prov_boundary.RData")
...
save(predict_data_results_0_5deg_without_prov_boundary, file = "step5_predict_and_post_adjustments_log_change/outputs/predict_data_results_0_5deg_without_prov_boundary.RData")
...
predict_data_results_1deg_from_0_5deg_without_prov_boundary <- predict_data_results_0_5deg_with_prov_boundary  %>% 
                                                   ...
                                                   ungroup()  %>% 
                                                   dplyr::select(c(cell_id, iso, year, pred_GCP_1deg_no_prov_bound, country_total_GDP, national_population, geom)) 
save(predict_data_results_1deg_from_0_5deg_without_prov_boundary, file = "step5_predict_and_post_adjustments_log_change/outputs/predict_data_results_1deg_from_0_5deg_without_prov_boundary.RData")
...
save(predict_data_results_0_25deg_with_prov_boundary, file = "step5_predict_and_post_adjustments_log_change/outputs/predict_data_results_0_25deg_with_prov_boundary.RData")
...
save(predict_data_results_0_25deg_without_prov_boundary, file = "step5_predict_and_post_adjustments_log_change/outputs/predict_data_results_0_25deg_without_prov_boundary.RData")
...
predict_data_results_1deg_from_0_25deg_without_prov_boundary <- predict_data_results_0_25deg_with_prov_boundary  %>% 
                                                   ...
                                                   ungroup()  %>% 
                                                   dplyr::select(c(cell_id, iso, year, pred_GCP_1deg_no_prov_bound, country_total_GDP, national_population, geom)) 
save(predict_data_results_1deg_from_0_25deg_without_prov_boundary, file = "step5_predict_and_post_adjustments_log_change/outputs/predict_data_results_1deg_from_0_25deg_without_prov_boundary.RData")
...
predict_data_results_0_5deg_from_0_25deg_without_prov_boundary <- predict_data_results_0_25deg_with_prov_boundary  %>% 
                                                   ...
                                                   ungroup()  %>% 
                                                   dplyr::select(c(cell_id, subcell_id, iso, year, pred_GCP_0_5deg_no_prov_bound, country_total_GDP, national_population, geom)) 
save(predict_data_results_0_5deg_from_0_25deg_without_prov_boundary, file = "step5_predict_and_post_adjustments_log_change/outputs/predict_data_results_0_5deg_from_0_25deg_without_prov_boundary.RData")
