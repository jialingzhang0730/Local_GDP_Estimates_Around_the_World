...
load("step5_predict_and_post_adjustments/outputs/predict_data_results_1deg_with_prov_boundary_model_up_to_2019.RData")
...
save(pred_1deg_with_prov_bound_postadjust_pop_dens_no_extra_adjust_upto_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/pred_1deg_with_prov_bound_postadjust_pop_dens_no_extra_adjust_upto_2019.RData")
...
save(GDPC_1deg_postadjust_pop_dens_no_extra_adjust_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_1deg_postadjust_pop_dens_no_extra_adjust_up_to_2019.RData")
