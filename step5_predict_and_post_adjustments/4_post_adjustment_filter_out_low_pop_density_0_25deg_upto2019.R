...
load("step5_predict_and_post_adjustments/outputs/predict_data_results_0_25deg_with_prov_boundary_model_up_to_2019.RData")
...
save(GDPC_0_25deg_postadjust_pop_dens_no_extra_adjust_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_0_25deg_postadjust_pop_dens_no_extra_adjust_up_to_2019.RData")
