...
#   file "2_put_all_isos_to_train_xdeg_up_to_2019.R"
# -------------------------------------------------------------------------------- #
...
#load the model
load("step4_benchmark_model/outputs/model9_tuning/put_all_isos_to_train/rf_model9_good_grid_search_1deg_up_to_2019.RData")
...
save(predict_data_results_1deg_with_prov_boundary_model_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_1deg_with_prov_boundary_model_up_to_2019.RData")
...
save(predict_data_results_1deg_without_prov_boundary_model_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_1deg_without_prov_boundary_model_up_to_2019.RData")

# ---------------------------------------------------------------------------------------------------------------------------------------
# 0.5 degree

#load the model
load("step4_benchmark_model/outputs/model9_tuning/put_all_isos_to_train/rf_model9_good_grid_search_0_5deg_up_to_2019.RData")
...
predict_data_results_0_5deg_with_prov_boundary_model_up_to_2019 <- predict_data_complete %>%
                              as.data.frame()  %>% 
                              mutate(pred_GCP_share_0_5deg = predictions_predict[,1])  %>% 
                              mutate(pred_GCP_share_0_5deg = ifelse(floor(pop) == 0, 0, pred_GCP_share_0_5deg))  %>%                               
                              group_by(id, year)  %>% 
...
save(predict_data_results_0_5deg_with_prov_boundary_model_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_0_5deg_with_prov_boundary_model_up_to_2019.RData")
...
save(predict_data_results_0_5deg_without_prov_boundary_model_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_0_5deg_without_prov_boundary_model_up_to_2019.RData")
...
#load the model
load("step4_benchmark_model/outputs/model9_tuning/put_all_isos_to_train/rf_model9_good_grid_search_0_25deg_up_to_2019.RData")
...
save(predict_data_results_0_25deg_with_prov_boundary_model_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_0_25deg_with_prov_boundary_model_up_to_2019.RData")
...
save(predict_data_results_0_25deg_without_prov_boundary_model_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_0_25deg_without_prov_boundary_model_up_to_2019.RData")
...
predict_data_results_1deg_from_0_25deg_without_prov_boundary_model_up_to_2019 <- predict_data_results_0_25deg_with_prov_boundary_model_up_to_2019  %>% 
                                                   ...
                                                   ungroup()  %>% 
                                                   dplyr::select(c(cell_id, iso, year, pred_GCP_1deg_no_prov_bound, country_total_GDP, national_population)) 
save(predict_data_results_1deg_from_0_25deg_without_prov_boundary_model_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_1deg_from_0_25deg_without_prov_boundary_model_up_to_2019.RData")
...
predict_data_results_0_5deg_from_0_25deg_without_prov_boundary_model_up_to_2019 <- predict_data_results_0_25deg_with_prov_boundary_model_up_to_2019  %>% 
                                                   ...
                                                   ungroup()  %>% 
                                                   dplyr::select(c(cell_id, subcell_id, iso, year, pred_GCP_0_5deg_no_prov_bound, country_total_GDP, national_population)) 
save(predict_data_results_0_5deg_from_0_25deg_without_prov_boundary_model_up_to_2019, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_0_5deg_from_0_25deg_without_prov_boundary_model_up_to_2019.RData")
