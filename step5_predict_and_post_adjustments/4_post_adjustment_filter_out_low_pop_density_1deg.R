...
load("step5_predict_and_post_adjustments/outputs/predict_data_results_1deg_with_prov_boundary.RData")
...
save(pred_1deg_with_prov_bound_postadjust_pop_dens_no_extra_adjust, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/pred_1deg_with_prov_bound_postadjust_pop_dens_no_extra_adjust.RData")

deg1_geometry <- read_sf("step5_predict_and_post_adjustments/outputs/country_1deg_intersected.gpkg")  %>% 
...
save(pop_cell_1deg, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/pop_cell_1deg.RData")                                                               
...
GDPC_1deg_postadjust_pop_dens_0_05_adjust_csv <- GDPC_1deg_postadjust_pop_dens_0_05_adjust  %>% 
  ...
  as.data.frame()  %>% 
  dplyr::select(-c(geom))
write.csv(GDPC_1deg_postadjust_pop_dens_0_05_adjust_csv, file = "step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_1deg_postadjust_pop_dens_0_05_adjust.csv", row.names = FALSE)
