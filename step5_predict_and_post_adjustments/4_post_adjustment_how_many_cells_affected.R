...
# ------------- 1degree ------------- #
deg1_no_adjust <- read.csv("step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_1deg_postadjust_pop_dens_no_extra_adjust.csv") %>% 
    group_by(year) %>%
...
deg1_adjust_0_01 <- read.csv("step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_1deg_postadjust_pop_dens_0_01_adjust.csv") %>% 
    group_by(year) %>%
    mutate(cell_affected = sum(is_cell_censored),
           num_zero_pop = sum(pop_cell == 0 & is_cell_censored),
           all_cells = n(),
...
write_xlsx(list_of_datasets, "step5_predict_and_post_adjustments/outputs/post_adjust_statistic/deg1.xlsx")

# ------------- 0.5degree ------------- #
deg0_5_no_adjust <- read.csv("step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_0_5deg_postadjust_pop_dens_no_extra_adjust.csv") %>% 
    group_by(year) %>%
    mutate(cell_affected = sum(is_cell_censored),
           num_zero_pop = sum(pop_cell == 0 & is_cell_censored),
           all_cells = n(),
...
deg0_5_adjust_0_01 <- read.csv("step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_0_5deg_postadjust_pop_dens_0_01_adjust.csv") %>% 
    group_by(year) %>%
    mutate(cell_affected = sum(is_cell_censored),
           num_zero_pop = sum(pop_cell == 0 & is_cell_censored),
           all_cells = n(),
...
# Write the data frames to an Excel file with multiple sheets
write_xlsx(list_of_datasets, "step5_predict_and_post_adjustments/outputs/post_adjust_statistic/deg0_5.xlsx")

# ------------- 0.25degree ------------- #
deg0_25_no_adjust <- read.csv("step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_0_25deg_postadjust_pop_dens_no_extra_adjust.csv") %>% 
    group_by(year) %>%
    mutate(cell_affected = sum(is_cell_censored),
           num_zero_pop = sum(pop_cell == 0 & is_cell_censored),
           all_cells = n(),
...
deg0_25_adjust_0_01 <- read.csv("step5_predict_and_post_adjustments/outputs/predict_data_results_postadjust_pop_density/GDPC_0_25deg_postadjust_pop_dens_0_01_adjust.csv") %>% 
    group_by(year) %>%
    mutate(cell_affected = sum(is_cell_censored),
           num_zero_pop = sum(pop_cell == 0 & is_cell_censored),
           all_cells = n(),
