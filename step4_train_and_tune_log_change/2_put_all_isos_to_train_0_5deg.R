...
train_rf <- function(data_full, df.cv = folds, name = "RF", tune_par = T){
  ...
  if(tune_par){
    ...
    save(tuning_results_0_5deg, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/tuning_results_0_5deg.RData")
    ...
    write.csv(best_model_metrics, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/best_model_metrics_0_5deg.csv", row.names = FALSE)
    ...
    save(rf_workflow_final, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/rf_workflow_final_0_5deg.RData")
    toc()
  }
  ...
  save(rf_fit_0_5deg, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/rf_fit_0_5deg.RData")
  toc()
...
save(rf_model9_good_grid_search_0_5deg, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/rf_model9_good_grid_search_0_5deg.RData")
toc()
