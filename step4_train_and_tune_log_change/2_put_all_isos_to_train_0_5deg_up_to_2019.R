...
train_rf <- function(data_full, df.cv = folds, name = "RF", tune_par = T){
  ...
  if(tune_par){
    ...
    rf_grid <- expand.grid(mtry = c(7,10,13,16),
                           trees = c(1000), # for 0.5deg, use trees = 1000 to reduce computational costs for trying other choices, # of trees will not affect the results too much
                           min_n = c(10,13,16,19))
    ...
    save(tuning_results_0_5deg, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/tuning_results_0_5deg_up_to_2019.RData")
    ...
    write.csv(best_model_metrics, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/best_model_metrics_0_5deg_up_to_2019.csv", row.names = FALSE)
    ...
    save(rf_workflow_final, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/rf_workflow_final_0_5deg_up_to_2019.RData")
    toc()
  }
  ...
  save(rf_fit_0_5deg, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/rf_fit_0_5deg_up_to_2019.RData")
  toc()
...
save(rf_model9_good_grid_search_0_5deg, file = "step4_train_and_tune_log_change/outputs/model9_tuning/put_all_isos_to_train/rf_model9_good_grid_search_0_5deg_up_to_2019.RData")
toc()
