...
setwd("/share/rossihansberglab/Nightlights_GDP/replication_packages_local_gdp")
...
system("step7_robust_analysis/model_tune_MSE/1_put_all_isos_to_train_1deg.R", intern = FALSE)
system("step7_robust_analysis/model_tune_MSE/1_put_all_isos_to_train_1deg_up_to_2019.R", intern = FALSE)
system("step7_robust_analysis/model_tune_MSE/1_put_all_isos_to_train_0_5deg.R", intern = FALSE)
system("step7_robust_analysis/model_tune_MSE/1_put_all_isos_to_train_0_25deg.R", intern = FALSE)
...
system("step7_robust_analysis/model_wo_developing/1_put_all_isos_to_train_1deg.R", intern = FALSE)
system("step7_robust_analysis/model_wo_developing/1_put_all_isos_to_train_1deg_up_to_2019.R", intern = FALSE)
system("step7_robust_analysis/model_wo_developing/1_put_all_isos_to_train_0_5deg.R", intern = FALSE)
system("step7_robust_analysis/model_wo_developing/1_put_all_isos_to_train_0_25deg.R", intern = FALSE)
...
system("step7_robust_analysis/model_wo_weights/1_put_all_isos_to_train_1deg.R", intern = FALSE)
system("step7_robust_analysis/model_wo_weights/1_put_all_isos_to_train_1deg_up_to_2019.R", intern = FALSE)
system("step7_robust_analysis/model_wo_weights/1_put_all_isos_to_train_0_5deg.R", intern = FALSE)
system("step7_robust_analysis/model_wo_weights/1_put_all_isos_to_train_0_25deg.R", intern = FALSE)
